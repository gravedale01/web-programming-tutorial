...
- [x] [HTML Preview](https://rawgit.com/gravedale01/web-programming-tutorial/master/index.html)
- [x] [Contacte](https://rawgit.com/gravedale01/web-programming-tutorial/master/contacts.html)
- [x] [Playing Cards Template](https://rawgit.com/gravedale01/web-programming-tutorial/master/templates/cards.html)
- [x] [Bootstrap Example](https://rawgit.com/gravedale01/web-programming-tutorial/master/index-bootstrap.html)
...
- add project in tomcat to make ajax calls (example to make link in webapps)
        ...
        mklink /J agenda c:\Producs\web-programming-tutorial
